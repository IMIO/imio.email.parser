...
# last commit: f0159b4c3d052144b7f42ff006eddf12dde967b1 ,  2020/09/26
    ...
    if part['Content-Transfer-Encoding'] == '8bit':
        ...
        if isinstance(payload, bytes):
            try:
                ...
                # IMIO
                payload = payload.decode(charset, errors='replace') if six.PY3 else payload
